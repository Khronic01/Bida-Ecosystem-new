...
export function FundsAllocation() {
  const data = [
    { name: "TGE Market Cap", value: 60, color: "#ff0099" },
    { name: "Ecosystem", value: 20, color: "#cc00ff" },
    { name: "CEX Listing", value: 10, color: "#9933ff" },
    { name: "Ecosystem Dev", value: 10, color: "#6600cc" },
  ]
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center space-y-4 sm:space-y-6 mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold">
            Funds <span className="gradient-text">Allocation</span>
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-foreground/70 leading-relaxed text-pretty">
            Strategic allocation of raised funds to ensure platform growth, liquidity, and ecosystem development.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="bg-card border border-border rounded-2xl p-4 sm:p-8 hover-glow">
